...
Labels: v2, docs, api, backend

## Summary

Complete and harden E1 documentation for the shared application service layer and draft v2 analyze contract.

## Scope

1. Ensure architecture docs reflect the application-layer boundary.
2. Ensure API docs reflect `/api/v2/analyze` behavior and constraints.
3. Add explicit breadcrumbs for next-session E1 closeout tasks.
